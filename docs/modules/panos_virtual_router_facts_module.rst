:source: panos_virtual_router_facts.py

:orphan:

.. _panos_virtual_router_facts_module:
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td></td>
                <td>
                                            <div>Admin distance for this protocol.</div>
                                        <br/>
                                    </td>
            </tr>
                                <tr>
                ...
                <td>
                                            <div>List of virtual router specs.</div>
                                        <br/>
                                    </td>
            </tr>
                        </table>
