                    ...
                    <div style="font-size: small">
                        <span style="color: purple">-</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Interface management profile name; it must already exist.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>MTU for tunnel interface.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">-</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Netflow profile for tunnel interface.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">-</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Name of the zone for the interface. If the zone does not exist it is created but</div>
                                                    <div>if the zone exists and it is not of the correct mode the operation will fail.</div>
                                                                                </td>
            </tr>
                        </table>
    <br/>
