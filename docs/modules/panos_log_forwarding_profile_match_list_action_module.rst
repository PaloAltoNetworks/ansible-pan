:source: panos_log_forwarding_profile_match_list_action.py

:orphan:

.. _panos_log_forwarding_profile_match_list_action_module:
            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">-</span>
                                ...
                                <td>
                                                                                                                            <ul style="margin: 0; padding: 0"><b>Choices:</b>
                                                                                                                                                                <li><div style="color: blue"><b>tagging</b>&nbsp;&larr;</div></li>
                                                                                                                                                                                                <li>integration</li>
                                                                                    </ul>
                                                                            </td>
                                                                <td>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">-</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>The HTTP profile when <em>registration=remote</em>.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                        ...
                        <span style="color: purple">-</span>
                         / <span style="color: red">required</span>                    </div>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Name of the log forwarding profile to add this action to.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    <b>log_forwarding_profile_match_list</b>
                    <div style="font-size: small">
                        <span style="color: purple">-</span>
                         / <span style="color: red">required</span>                    </div>
                                    </td>
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Name of the log forwarding profile match list to add this action to.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
