:source: panos_loopback_interface.py

:orphan:

.. _panos_loopback_interface_module:
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>MTU for loopback interface.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">-</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Netflow profile for loopback interface.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">-</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Name of the zone for the interface. If the zone does not exist it is created but if the</div>
                                                    <div>zone exists and it is not of the correct mode the operation will fail.</div>
                                                                                </td>
            </tr>
                        </table>
    <br/>
