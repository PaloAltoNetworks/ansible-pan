                    ...
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Length of time (in seconds) to wait before doing any readiness checks.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Length of time (in seconds) to wait between checks.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Length of time (in seconds) to wait for jobs to finish.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
