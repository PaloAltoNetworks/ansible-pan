:source: panos_bgp_redistribute.py

:orphan:

.. _panos_bgp_redistribute_module:
                        ...
                        <span style="color: purple">-</span>
                         / <span style="color: red">required</span>                    </div>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>An IPv4 subnet or a defined Redistribution Profile in the virtual router.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Add the AS_PATHLIMIT path attribute.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">list</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Add the COMMUNITY path attribute.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    <b>set_extended_community</b>
                    <div style="font-size: small">
                        <span style="color: purple">list</span>
                                            </div>
                                    </td>
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Add the EXTENDED COMMUNITY path attribute.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    <b>set_local_preference</b>
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                                            </div>
                                    </td>
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Add the LOCAL_PREF path attribute.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Add the MULTI_EXIT_DISC path attribute.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
