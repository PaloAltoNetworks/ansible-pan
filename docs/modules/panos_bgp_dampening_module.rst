:source: panos_bgp_dampening.py

:orphan:

.. _panos_bgp_dampening_module:
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">float</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Cutoff threshold value.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    <b>decay_half_life_reachable</b>
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Decay half-life while reachable (in seconds).</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    <b>decay_half_life_unreachable</b>
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                                            </div>
                                    </td>
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Decay half-life while unreachable (in seconds).</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Maximum of hold-down time (in seconds).</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                        ...
                        <span style="color: purple">-</span>
                         / <span style="color: red">required</span>                    </div>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Name of Dampening Profile.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
