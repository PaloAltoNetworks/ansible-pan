                        ...
                        <span style="color: purple">-</span>
                         / <span style="color: red">required</span>                    </div>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>The OP command to be performed.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>The cmd is already given in XML format, so don&#x27;t convert it.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>success</td>
                <td>
                                            <div>output of the given OP command as JSON formatted string</div>
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">{system: {app-release-date: 2017/05/01  15:09:12}}</div>
                                    </td>
            </tr>
                                <tr>
                                <td colspan="1">
                ...
                <td>success</td>
                <td>
                                            <div>output of the given OP command as an XML formatted string</div>
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">&lt;response status=success&gt;&lt;result&gt;&lt;system&gt;&lt;hostname&gt;fw2&lt;/hostname&gt;</div>
                                    </td>
            </tr>
                        </table>
    <br/><br/>
