:source: panos_address_object.py

:orphan:

.. _panos_address_object_module:
                        ...
                        <span style="color: purple">-</span>
                                ...
                                <td>
                                                                                                                            <ul style="margin: 0; padding: 0"><b>Choices:</b>
                                                                                                                                                                <li><div style="color: blue"><b>ip-netmask</b>&nbsp;&larr;</div></li>
                                                                                                                                                                                                <li>ip-range</li>
                                                                                                                                                                                                <li>fqdn</li>
                                                                                    </ul>
                                                                            </td>
                                                                <td>
                                                                        <div>Type of address object.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">-</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Descriptive name for this address object.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">list</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>List of tags to add to this address object.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                        ...
                        <span style="color: purple">-</span>
                         / <span style="color: red">required</span>                    </div>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>IP address, IP range, or FQDN for the object.  Must specify if state is <em>present</em>.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
