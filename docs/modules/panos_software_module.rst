                        ...
                        <span style="color: purple">-</span>
                         / <span style="color: red">required</span>                    </div>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Desired PAN-OS release for target device.</div>
                                                                                </td>
            </tr>
                        </table>
    <br/>
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td></td>
                <td>
                                            <div>After performing the software install, returns the version installed on the device.</div>
                                        <br/>
                                    </td>
            </tr>
                        </table>
