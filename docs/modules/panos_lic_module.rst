                    ...
                    <div style="font-size: small">
                        <span style="color: purple">-</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>authcode to be applied.</div>
                                                    <div>If this is not given, then &quot;request license fetch&quot; is performed instead.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Whether to apply authcode even if device is already licensed / has a serial number.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <th width="100%">Description</th>
                ...
                <td>when not using auth_code</td>
                <td>
                                            <div>List of PAN-OS licenses (as dicts) as a result of this module&#x27;s execution.</div>
                                        <br/>
                                    </td>
            </tr>
                                <tr>
                ...
                <td>success</td>
                <td>
                                            <div>PAN-OS serial number when this module began execution.</div>
                                        <br/>
                                            <div style="font-size: smaller"><b>Sample:</b></div>
                                                <div style="font-size: smaller; color: blue; word-wrap: break-word; word-break: break-all;">973080716</div>
                                    </td>
            </tr>
                        </table>
    <br/><br/>
