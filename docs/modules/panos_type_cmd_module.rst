                    ...
                    <div style="font-size: small">
                        <span style="color: purple">-</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Used in <em>cmd=move</em>.</div>
                                                    <div>The reference object.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">-</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Used in <em>cmd=set</em>, <em>cmd=edit</em>, and <em>cmd=override</em>.</div>
                                                    <div>The element payload.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">complex</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>A dict of extra params to pass in.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">-</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Used in <em>cmd=rename</em> and <em>cmd=clone</em>.</div>
                                                    <div>The new name.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                        ...
                        <span style="color: purple">-</span>
                         / <span style="color: red">required</span>                    </div>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>The XPATH.</div>
                                                    <div>All newlines are removed from the XPATH to allow for shorter lines.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">-</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Used in <em>cmd=clone</em>.</div>
                                                    <div>The from xpath.</div>
                                                                                </td>
            </tr>
                        </table>
    <br/>
