:source: panos_syslog_server.py

:orphan:

.. _panos_syslog_server_module:
            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                        ...
                        <span style="color: purple">-</span>
                                ...
                                <td>
                                                                                                                            <ul style="margin: 0; padding: 0"><b>Choices:</b>
                                                                                                                                                                <li><div style="color: blue"><b>LOG_USER</b>&nbsp;&larr;</div></li>
                                                                                                                                                                                                <li>LOG_LOCAL0</li>
                                                                                                                                                                                                <li>LOG_LOCAL1</li>
                                                                                                                                                                                                <li>LOG_LOCAL2</li>
                                                                                                                                                                                                <li>LOG_LOCAL3</li>
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">-</span>
                                ...
                                <td>
                                                                                                                            <ul style="margin: 0; padding: 0"><b>Choices:</b>
                                                                                                                                                                <li><div style="color: blue"><b>BSD</b>&nbsp;&larr;</div></li>
                                                                                                                                                                                                <li>IETF</li>
                                                                                    </ul>
                                                                            </td>
                                                                <td>
                                                                        <div>Format of the syslog message.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                        ...
                        <span style="color: purple">-</span>
                         / <span style="color: red">required</span>                    </div>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>IP address or FQDN of the syslog server</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                        ...
                        <span style="color: purple">-</span>
                         / <span style="color: red">required</span>                    </div>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>Name of the syslog server profile.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
