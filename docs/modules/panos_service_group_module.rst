:source: panos_service_group.py

:orphan:

.. _panos_service_group_module:
                    ...
                    <div style="font-size: small">
                        <span style="color: purple">list</span>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>List of tags for this service group.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
                        ...
                        <span style="color: purple">list</span>
                         / <span style="color: red">required</span>                    </div>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>List of service objects to be included in the group.  Must specify if state is present.</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="2">
