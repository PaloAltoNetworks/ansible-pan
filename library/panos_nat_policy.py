...
short_description: Create NAT policies on PAN-OS devices.
description:
    - Create NAT policies on PAN-OS devices.
...
PANOS_NAT_POLICY_REQUIRED_IF_ARGS = [
...
def main():
    module = PanOSAnsibleModule(
        argument_spec=PANOS_NAT_POLICY_ARGSPEC,
        required_if=PANOS_NAT_POLICY_REQUIRED_IF_ARGS
    )
